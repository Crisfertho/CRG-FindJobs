<div class="px-14">
    <div class="bg-gray-100 dark:bg-gray-300 p-10 rounded-b-lg">
        ...
        <div class="max-w-6xl mx-auto">
            <form wire:submit.prevent="leerDatosFormulario">
                ...
                <div class="flex justify-end">
                    <input 
                        type="submit"
                        class="dark:bg-gray-600 bg-gray-800 text-white hover:bg-gray-600 dark:hover:bg-gray-500 transition-color text-sm font-bold px-10 py-2 rounded cursor-pointer uppercase w-full md:w-auto"
                        value="Buscar"
                    />
                </div>
            </form>
